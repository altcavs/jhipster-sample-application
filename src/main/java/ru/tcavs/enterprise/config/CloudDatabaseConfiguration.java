package ru.tcavs.enterprise.config;
...
@Configuration
@EnableMongoRepositories("ru.tcavs.enterprise.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("ru.tcavs.enterprise.config.dbmigrations");
